...
- **提交待审批账户**：`POST /api/public/pending-accounts`
...
> 📖 **详细接口文档**: [docs/public_api.md](./docs/public_api.md)

### 管理员操作端点

- **列出待审批账户**：`GET /api/admin/pending-accounts`
- **批准账户**：`POST /api/admin/pending-accounts/{id}/approve`
- **拒绝账户**：`POST /api/admin/pending-accounts/{id}/reject`
